...
INSERT INTO "epochs" VALUES('<DATE>_t1_racing','9d61e8a4bbd6ea6a3a0601defd013d9687da88fe2575e407fabef006fd2af352','<TS>',0,'',NULL);
...
INSERT INTO "experiments" VALUES('<DATE>_t1_racing','v0','baseline seed','','{"core_idea": "baseline seed", "expected_metric_movements": [], "expected_pass_rate_delta": "", "modulating": [], "risks": "", "why": ""}',NULL,NULL,NULL,NULL,NULL,NULL);
INSERT INTO "experiments" VALUES('<DATE>_t1_racing','v1','Tag the topic_slugify_logic literal for candidate v1.','A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run.','{"core_idea": "Tag the topic_slugify_logic literal for candidate v1.", "expected_metric_movements": [{"direction": "neutral", "magnitude": "small", "metric_name": "drift:off_topic"}], "expected_pass_rate_delta": "+0.0 to +0.1", "modulating": ["topic_slugify_logic"], "risks": "The change is cosmetic; candidate v1 is not expected to move the board.", "why": "A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run."}','promoted','',-1.6,-1.6,0.0,'{"champion_eval_mode": "full", "drift_loss_delta": -1.6, "eliminated_in_round": null, "evidence": {"confirmation_status": "disabled", "present": false, "reason": "no promotion confidence threshold in the evaluation contract"}, "final_rank": 2, "generalization_gap": 0.0, "holdout": {"confirmation_status": "satisfied", "confirmed": true, "holdout_consulted": true, "holdout_scalar": 0.4, "ladder_budget_before_query": 16, "ladder_budget_remaining": 15, "ladder_budget_total": 16, "ladder_query_reserved": true, "ladder_released": true, "reason": "", "threshold": 0.01, "train_scalar": 0.4}, "holdout_loss": 0.4, "match_record": [{"delta_scalar": -1.6, "match_id": "rung0_m0", "opponent": "v0", "won": true}, {"delta_scalar": -1.6, "match_id": "rung1_m0", "opponent": "v0", "won": true}, {"delta_scalar": -1.6, "match_id": "racing-final", "opponent": "v0", "won": true}], "metric_movements": [], "operator_override": false, "operator_override_reason": "", "pass_rate_delta": 0.0, "ran_at": "<TS>", "rejection_reason": "", "scalar_score_delta": -1.6, "structure": "racing", "tournament_decision": "promoted", "train_loss": 0.4}');
INSERT INTO "experiments" VALUES('<DATE>_t1_racing','v2','Tag the topic_slugify_logic literal for candidate v2.','A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run.','{"core_idea": "Tag the topic_slugify_logic literal for candidate v2.", "expected_metric_movements": [{"direction": "neutral", "magnitude": "small", "metric_name": "drift:off_topic"}], "expected_pass_rate_delta": "+0.0 to +0.1", "modulating": ["topic_slugify_logic"], "risks": "The change is cosmetic; candidate v2 is not expected to move the board.", "why": "A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run."}','rejected','',-1.2,0.0,0.0,'{"champion_eval_mode": "full", "drift_loss_delta": 0.0, "eliminated_in_round": null, "evidence": null, "final_rank": 3, "generalization_gap": null, "holdout": null, "holdout_loss": null, "match_record": [{"delta_scalar": -1.2, "match_id": "rung0_m1", "opponent": "v0", "won": true}, {"delta_scalar": -1.2, "match_id": "rung1_m1", "opponent": "v0", "won": true}], "metric_movements": [], "operator_override": false, "operator_override_reason": "", "pass_rate_delta": 0.0, "ran_at": "<TS>", "rejection_reason": "", "scalar_score_delta": -1.2, "structure": "racing", "tournament_decision": "rejected", "train_loss": 0.8}');
INSERT INTO "experiments" VALUES('<DATE>_t1_racing','v3','Tag the topic_slugify_logic literal for candidate v3.','A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run.','{"core_idea": "Tag the topic_slugify_logic literal for candidate v3.", "expected_metric_movements": [{"direction": "neutral", "magnitude": "small", "metric_name": "drift:off_topic"}], "expected_pass_rate_delta": "+0.0 to +0.1", "modulating": ["topic_slugify_logic"], "risks": "The change is cosmetic; candidate v3 is not expected to move the board.", "why": "A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run."}','rejected','',-0.8,0.0,0.0,'{"champion_eval_mode": "full", "drift_loss_delta": 0.0, "eliminated_in_round": null, "evidence": null, "final_rank": 4, "generalization_gap": null, "holdout": null, "holdout_loss": null, "match_record": [{"delta_scalar": -0.8, "match_id": "rung0_m2", "opponent": "v0", "won": true}], "metric_movements": [], "operator_override": false, "operator_override_reason": "", "pass_rate_delta": 0.0, "ran_at": "<TS>", "rejection_reason": "", "scalar_score_delta": -0.8, "structure": "racing", "tournament_decision": "rejected", "train_loss": 1.2}');
INSERT INTO "experiments" VALUES('<DATE>_t1_racing','v4','Tag the topic_slugify_logic literal for candidate v4.','A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run.','{"core_idea": "Tag the topic_slugify_logic literal for candidate v4.", "expected_metric_movements": [{"direction": "neutral", "magnitude": "small", "metric_name": "drift:off_topic"}], "expected_pass_rate_delta": "+0.0 to +0.1", "modulating": ["topic_slugify_logic"], "risks": "The change is cosmetic; candidate v4 is not expected to move the board.", "why": "A mechanical stand-in proposes a minimal, well-formed change so the loop under test has a real candidate to run."}','rejected','',-0.3999999999999999,0.0,0.0,'{"champion_eval_mode": "full", "drift_loss_delta": 0.0, "eliminated_in_round": null, "evidence": null, "final_rank": 5, "generalization_gap": null, "holdout": null, "holdout_loss": null, "match_record": [{"delta_scalar": -0.3999999999999999, "match_id": "rung0_m3", "opponent": "v0", "won": true}], "metric_movements": [], "operator_override": false, "operator_override_reason": "", "pass_rate_delta": 0.0, "ran_at": "<TS>", "rejection_reason": "", "scalar_score_delta": -0.3999999999999999, "structure": "racing", "tournament_decision": "rejected", "train_loss": 1.6}');
...
INSERT INTO "generations" VALUES('<DATE>_t1_racing','v0',NULL,NULL,'',NULL,1289.4320581849881,NULL,8);
INSERT INTO "generations" VALUES('<DATE>_t1_racing','v1','v0',1,'<TS>',0,1678.3808441189965,NULL,6);
INSERT INTO "generations" VALUES('<DATE>_t1_racing','v2','v0',0,'<TS>',0,1576.322983622206,NULL,4);
INSERT INTO "generations" VALUES('<DATE>_t1_racing','v3','v0',0,'<TS>',0,1477.9320570369046,NULL,2);
INSERT INTO "generations" VALUES('<DATE>_t1_racing','v4','v0',0,'<TS>',0,1477.9320570369046,NULL,2);
...
INSERT INTO "ingest_cursors" VALUES('<DATE>_t1_racing',5,0,1,0,4,'<TS>');
