...
- [`docs/design/DASHBOARD.md`](docs/design/DASHBOARD.md) — the live UI for an in-flight epoch: HTTP + SSE architecture, the seven panels (active tournament with predicted gate verdict, lineage, score trajectory, drift heatmap, log tail, ...), v1.3 control-file protocol for operator actions, full API surface.
