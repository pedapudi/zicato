...
- **Screening (the `screen_entries` knob, arm A2) — reversed null.** The
  ...
  **keep** it only if the screening arm clears the bar over BASE. If that arm
  ...
  `ScoringWeights()`**, taking the scaffold default to `0`. (The
