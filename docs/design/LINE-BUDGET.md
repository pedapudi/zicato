...
|---|---:|---:|---:|
| Total | 408,547 | 418,860 | -10,313 |
| Production | 197,588 | 201,642 | -4,054 |
...
| Dry-run reachability probe (total) | 418,360 | +500 | 418,860 | Issue #264: the probe module, its dry-run wiring, and the stub-driven per-role coverage including the keyless-spec and bounded-timeout pins. |
| Dry-run reachability probe (production) | 201,427 | +215 | 201,642 | Issue #264: the per-role bounded round trip through the worker's construction seam, the per-role report renderer, and the dry-run report-and-exit wiring. |
