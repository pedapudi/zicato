"""Configuration edits, validation and execution cost estimates."""
...
def test_set_gate_monotonicity_scope() -> None:
    ...
    # Serialization preserves the selected rule.
...
def test_set_holdout_ladder_partial_mapping() -> None:
    ...
    with pytest.raises(ValueError, match=r"set_holdout\.ladder\.nope: unknown field"):
...
def test_set_gate_holdout_confirmation_bounds() -> None:
    """None preserves the bound; a negative margin restores automatic selection."""
    import pytest
