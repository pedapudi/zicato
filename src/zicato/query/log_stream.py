"""Select operational log invocations and assemble the shared bounded reader's view.

The CLI and dashboard use the same invocation roster, filtering and byte cursor.
Saved row decoding belongs to :mod:`zicato.logging_stream`.
"""
...
from zicato.logging_stream import tail_records
    ...
    *,
    ...
    Returns::

        {
          ...
          "cursor": <int|None>,      # byte offset after the last complete line
