...
// by the resolving fetch putting the pre-invalidation payload back. Nothing
// writes the cache after the fetch resolves now, so a bust during flight stays
// bust — the next caller starts a fresh fetch and the abandoned promise
