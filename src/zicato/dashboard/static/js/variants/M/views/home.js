// variants/M/views/home.js — HOME / ENVIRONMENT: the workspace as a fleet.
//
// Ledger II leads its home screen editorially: an eyebrow + serif title + a
// report-style lede, an overview strip, the per-epoch loss TRENDLINE fleet
// cards, loop health, and a cross-epoch trajectory figure with a caption.
//
// Data: /api/workspace, /api/health-report, plus live AppState for phase.
...
export async function render(host, ctx) {
  if (!host.firstChild) host.appendChild(el('p', { class: 'd-empty', text: 'Acquiring fleet telemetry…' }));
