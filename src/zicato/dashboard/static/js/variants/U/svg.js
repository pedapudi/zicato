// variants/U/svg.js — dependency-free SVG data-viz primitives (Atlas V).
//
// Self-contained for Variant U ("Atlas V"). Mark CSS classes are `dn-*` and
// are styled — scoped under the variant root — by css/variants/U/atlasv.css.
//
// Atlas V is the ROOMY, light convergence-IV sibling: the same marks as the
// console base but presented with generous spacing. Crucially for the brief:
// NO pan/zoom viewports — every mark fits its container. Three marks matter
// most:
...
//     themed in one place, swapped by the [data-u-theme] attribute.
