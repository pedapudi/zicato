// variants/U/views/candidate.js — CANDIDATE, comparison-first.
//
// The signature comparison screen (carried from S into Atlas V). One candidate's lifecycle reads on the left; a
...
export async function render(host, ctx, route) {
  ...
  gatedSwap(host, digest, () => {
    ...
    nodes.push(el('div', { class: 'vu-cmp-bar' }, [
      comparePicker({
        label: 'compare with…',
      ...
      cmpId ? el('button', { class: 'vu-cmp-clear', type: 'button', text: 'clear comparison',
