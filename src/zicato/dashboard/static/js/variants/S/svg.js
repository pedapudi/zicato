// variants/S/svg.js — dependency-free SVG data-viz primitives (Lens).
//
// Self-contained for Variant S ("Lens"). Mark CSS classes are `dn-*` and
// are styled — scoped under the variant root — by css/variants/S/lens.css.
//
