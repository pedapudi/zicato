// variants/S/dag.js — the compact candidate-lifecycle DAG (Lens).
//
...
// styled (scoped under the variant root) by css/variants/S/lens.css. The PATCH
// node accepts an `onPatch` handler so it is clickable → the candidate's
// side-by-side patch diff (fix #2).
