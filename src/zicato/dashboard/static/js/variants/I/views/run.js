// variants/I/views/run.js — RUN DETAIL: the transcript.
//
...
// deep-link (e.g. #/I/run/v1/waffles_single opened directly) this view
...
// constrained, scrollable container (height + overflow-y:auto) — no
// absolute positioning that could overlap lines (the round-3 discipline).
//
