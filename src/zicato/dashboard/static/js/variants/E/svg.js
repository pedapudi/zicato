// variants/E/svg.js — dependency-free SVG data-viz primitives (Atlas).
//
// Self-contained for Variant E ("Atlas"). Mark CSS classes are `d-*` and
// are styled — scoped under the variant root — by css/variants/E/atlas.css.
//
